...
def seed_reviews():
    ...
    review11 = Review(
      userId=6,
      spotId=3,
      review='This place was a dream. The hospitality was amazing, and the house was even better! Lying by the pool and soaking in the sun was so relaxing.',
      rating=5,
    )
    review12 = Review(
      userId=2,
      spotId=3,
      review='So amazing, the house was beautiful. Loved our time there!',
      rating=5,
    )
    review13 = Review(
      userId=5,
      spotId=3,
      review='Soooooo beautiful. Truly enjoyed our time there, the house was incredible!!!',
      rating=5,
    )
    review14 = Review(
      userId=4,
      spotId=3,
      review='LOVED IT! Rent this out you will not regret it!',
      rating=5,
    )
    review15 = Review(
      userId=1,
      spotId=3,
      review='The house was astonishing! Perfect vacation spot in a home that offers great relaxation and enjoyment.',
      rating=5,
    )
    # review16 = Review(
    #   userId=1,
